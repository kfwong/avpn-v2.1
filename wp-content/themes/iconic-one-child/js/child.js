...
/*
	$('#acf-organisation_name.field_type-post_object option').each(function(){
		$(this).text($(this).text().replace(/ \(all\)$| \(en\)$/g,''));
	});

	$('#acf-organisation_name.field_type-post_object .select2-search-choice div').each(function(){
		$(this).text($(this).text().replace(/ \(all\)$| \(en\)$/g,''));
	});
*/
		...
		var map = AmCharts.makeChart("chartdiv", {
			...
			dataProvider: {
				...
				images: [{
					...
					longitude: 103.8500,
					color: "#EE2E22",
					description: "org1, org2, org3",
					balloonText: "[[title]] (3)<br/>[[description]]"
				}, {
					svgPath: targetSVG,
					zoomLevel: 5,
					scale: 0.5,
